...
#set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports step]
...
#set_property DONT_TOUCH true [get_cells * -filter {NAME !~ "dbg_hub"}]


#set_input_delay -clock [get_clocks sys_clk_pin] -min -add_delay 1.500 [get_ports rst]
#set_input_delay -clock [get_clocks sys_clk_pin] -max -add_delay 1.500 [get_ports rst]
